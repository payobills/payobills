...
use crate::api::parses::{patch_normalized_amount_handler, post_new_parse_handler};
...
pub(crate) fn create_router() -> Router {
    return Router::new()
        ...
        .route(
            "/api/parses/:transaction_id/normalized_amount",
            patch(patch_normalized_amount_handler),
        )
}
